...
<script>
    ...
    // mapGetters, mapState, mapMutations, mapGetters
    import { mapActions } from "vuex";

    // console.log(mapActions(["LOGIN_ACTION"]))
        ...
        methods: {
            ...
            login(e) {
                ...
                this.$refs.loginForm.validate().then(valid => {
                    ...
                    // this.$store.dispatch("LOGIN_ACTION", this.form).then(res => {
                    //     if (!res) {
                    //         return this.reloadCaptcha();
                    //     }
                    //     this.$router.replace("/admin");
                    // })
                    this.LOGIN_ACTION(this.form).then().then(res => {
                        if (!res) {
                            return this.reloadCaptcha();
                        }
                        this.$router.replace("/admin");
